...
module.exports = function(core){
	core.on('text', function(action, callback){
		if(!action.room.guides || !action.room.guides.authorizer.writeLevel) return callback();
		if(action.room.guides.authorizer.writeLevel === undefined) action.room.guides.authorizer.writeLevel = 'guest';
