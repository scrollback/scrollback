...
var handlers = {}, catSeq = {
	...
	"config":["setters"], /* rename this as http/config */
	"rooms":["loader","cache","storage"],
	"messages":["storage"], /* rename: getTexts */
	"text":["loader","storage"],
	"back":["loader","storage"],
	"away":["loader","storage"],
	"join":["loader","storage"],
	"part":["loader","storage"],
	"kick":["loader","storage"],
	"admit":["loader","storage"],
	"expel":["loader","storage"],
	"getUsers":["loader","storage"],
	"getRooms":["loader","storage"],
	"user":["loader","storage"],
	/* room, user */
	"edit":["loader","storage"],
	"init":["loader","storage"]
