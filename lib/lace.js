...
var lace = {
    animate: {
         ...
         * @constructor
         * @param {{ element: String, event: String, classname: String, action: Function, support: Boolean }} options
         */
            ...
            if (options.support && $element.is(":visible") && document.hasFocus()) {
                var onanimate = function() {
                    if ($element.data("lace.animate")) {
                        $element.removeClass(options.classname).data("lace.animate", false);
                ...
                }).addClass(options.classname).data("lace.animate", true);
