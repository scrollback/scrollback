...
describe("parse and build", function() {
	it("should parse url to state and build same url from the state", function() {
		var path = "/someroom/abc456def?t=1214340045721&embed=%7B%22form%22%3A%22toast%22%2C%22minimize%22%3Afalse%7D&d=createroom&ds=%257B%2522signingUp%2522%253Afalse%257D&v=sidebar-right";
