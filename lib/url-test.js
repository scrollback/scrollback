...
describe("parse", function() {
	...
	it("should parse url with query parameters", function() {
		var path = "/someroom/abc456def?d=createroom&e=(form:toast,minimize:--)&g=(signingUp:--)&t=+HgyJfkP&v=sidebar~Frighth";
...
describe("build", function() {
	...
	it("should build url with context", function() {
		...
		assert.equal(url.build(state), "/someroom/all?e=(form:toast,minimize:++)");
	});
	...
	it("should build url with threadRange", function() {
		...
		assert.equal(url.build(state), "/someroom?t=+HgyJfkP");
	});
	...
	it("should build url with textRange", function() {
		...
		assert.equal(url.build(state), "/someroom/abc456def?t=+KtxIeuU");
	});
	...
	it("should shorten properties", function() {
		...
		assert.equal(url.build(state), "/someroom?d=createroom&g=(signingUp:--)&v=sidebar~Fright");
	});
...
describe("parse and build", function() {
	it("should parse url to state and build same url from the state", function() {
		var path = "/someroom/abc456def?t=+HgyJfkP&e=(form:toast,minimize:--)&d=createroom&g=(signingUp:--)&v=sidebar~Fright";
