...
module.exports = function(core) {
	...
	core.on("statechange", function(changes) {
		...
		relations.forEach(function(rel) {
			...
			sections[rel.role].push(React.createElement(RoomCard, {roomId: rel.roomId, discussionCount: "2"}));
		});
		...
		React.render(React.createElement(GridView, {sections: sectionsarr}), document.getElementByClassName(".main-content-rooms"));
	}, 500);
};
