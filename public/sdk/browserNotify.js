var browserNotify = (function() {
	...
	var play = (function() {
                ...
                return function (filename) {
                    ...
                    el.innerHTML='<audio autoplay="autoplay"><source src="' + sound + '" type="audio/wav" /><embed hidden="true" autostart="true" loop="false" src="' + sound +'" /></audio>';
                };
            }());
	...
	return function(text, force) {
		...
		if (!soundTimer) {
			play();
			soundTimer = setTimeout(function() { soundTimer = null; }, 60000);
		}
	};
}());
