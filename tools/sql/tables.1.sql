...
CREATE TABLE `messages` (
  ...
  `roomRef` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `msgRef` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=528 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='	';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-06-08 19:15:43
